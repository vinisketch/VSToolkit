...
import { SUPPORT_3D_TRANSFORM, clone, defineClassProperties, defineClassProperty, extend, extendClass, free, isArray, isFunction, isNumber, isString, setElementTransform } from 'vs_utils';
import { addPointerListener, removePointerListener } from 'vs_gesture';
import vs_ui, { OpacityAnimation, RecognizerManager, RotateXYZAnimation } from 'vs_ui';
...
extendClass(Controller$1, vs_core.EventSource);

/********************************************************************
                  Define class properties
********************************************************************/

defineClassProperties (Controller$1, {
  'initialComponent': {
    /*****************************************************************
...
extendClass (StackController, Controller$1);
...
export { CardController, Controller$1 as Controller, CubicController, NavigationController, OpacityController, SlideController, StackController, SwipeController };
