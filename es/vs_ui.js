import vs_utils$1, { CSS_VENDOR, SUPPORT_3D_TRANSFORM, clone, defineClassProperties, extendClass, isArray, isNumber, isString, setElementTransform } from 'vs_utils';
import vs_core$1, { Task, VSObject, createId, scheduleAction } from 'vs_core';
import { GESTURE_CHANGE, GESTURE_END, GESTURE_START, POINTER_CANCEL as POINTER_CANCEL$1, POINTER_END, POINTER_MOVE, POINTER_START, addPointerListener, removePointerListener } from 'vs_gesture';
...
View.prototype = {
  ...
  _clone_properties_value : function (obj, cloned_map)
  {
    ...
    for (key in this)
    {
      ...
      { vs_core$1.VSObject.__propertyCloneValue (key, this, obj); }
    }
  },
  ...
  __getGUInode : function (config)
  {
    ...
    if (node_ref)
    {
      ...
      {
        root_node = null;
        obj = vs_core$1.VSObject._obs [root_id];
  ...
  viewDidAdd : function ()
  {
    ...
    vs_core$1.scheduleAction (function () {
...
********************************************************************/
  ...
  _show_object : function (clb)
  {
    ...
    if (this.__show_clb || clb)
    {
      ...
      {
        if (this.__show_clb) {
          vs_core$1.scheduleAction (function () {self.__show_clb.call (self);});
        }
        if (clb) {
          vs_core$1.scheduleAction (function () {clb.call (self);});
        }
      }
    }
  },
  ...
  _hide_object: function (clb)
  {
    ...
    if (this.__hide_clb || clb)
    {
      ...
      {
        if (this.__hide_clb) {
          vs_core$1.scheduleAction (function () {self.__hide_clb.call (self);});
        }
        if (clb) {
          vs_core$1.scheduleAction (function () {clb.call (self);});
        }
...
********************************************************************/
  ...
  flushTransformStack : function ()
  {
    ...
    var matrix = new vs_utils$1.CSSMatrix ();
  ...
  getCTM: function ()
  {
    var matrix, identity = new vs_utils$1.CSSMatrix ();
  ...
  getParentCTM: function ()
  {
    ...
    function multiplyParentTCM (parent)
    {
      ...
      if (!parent) return new vs_utils$1.CSSMatrix ();
...
vs_utils$1.extend (View.prototype, RecognizerManager);
vs_utils$1.extendClass (View, vs_core$1.EventSource);

/********************************************************************
                  Define class properties
********************************************************************/

vs_utils$1.defineClassProperties (View, {
...
Application.prototype = {
  ...
  {
    vs_core$1.DataFlow._default_df_.build ();
  },
...
vs_utils$1.extendClass (Application, View);
...
Application.start = function ()
{
  ...
  for (key in Application._applications)
  {
    ...
    vs_core$1.scheduleAction (function () {obj.refresh ();});
  }
  vs_core$1.scheduleAction (function () {vs_core$1.DataFlow._default_df_.build ();});
};
...
Application.stop = function ()
{
  ...
  for (var key in vs_core$1.VSObject._obs)
  {
    var obj = vs_core$1.VSObject._obs [key];
    vs_utilsfree (obj);
  }
};
...
vs_utils$1.extendClass (TapRecognizer, PointerRecognizer);
...
vs_utils$1.extendClass (Button, View);
...
vs_utils$1.extendClass (Canvas, View);
...
//   },
  ...
  refresh : function ()
  {
    ...
    vs_core$1.scheduleAction (endRefresh.bind (this));
  },
...
vs_utils$1.extendClass (ScrollView, View);
...
vs_utils$1.extendClass (ComboBox, View);
...
vs_utils$1.extendClass (ImageView, View);
...
vs_utils$1.extendClass (InputField, View);
...
vs_utils$1.extendClass (AbstractListItem, View);
...
vs_utils$1.extendClass (SimpleListItem, View);
...
vs_utils$1.extendClass (NavigationBar$1, View);
...
Picker.prototype = {
  ...
  _generate_button: function (i)
  {
    ...
    if (!readonly)
    {
      ...
      addPointerListener (button_incr, POINTER_CANCEL$1, this);
    }
    ...
    if (!readonly)
    {
      ...
      addPointerListener (button_decr, POINTER_CANCEL$1, this);
    }
...
vs_utils$1.extendClass (Picker, View);
...
vs_utils$1.extendClass (PopOver$1, View);
...
vs_utils$1.extendClass (ProgressBar, View);
...
vs_utils$1.extendClass (SegmentedButton, View);
...
vs_utils$1.extendClass (Slider, View);
...
vs_utils$1.extendClass (SVGView, View);
...
vs_utils$1.extendClass (Switch, View);
...
vs_utils$1.defineClassProperties (Switch, {
  ...
  'toggled': {
    ...
    {
      var self = this;
      vs_core$1.scheduleAction (function () { self._setToggle (v); });
    },
...
vs_utils$1.extendClass (TextArea, View);
...
vs_utils$1.extendClass (TextLabel, View);
...
vs_utils$1.extendClass (ToolBar$1, View);
...
vs_utils$1.extendClass (ToolBar$1.Text, View);
...
vs_utils$1.extendClass (ToolBar$1.Button, View);
...
export { Application, Button, Canvas, CheckBox, ComboBox, ImageView, InputField, AbstractList, List, AbstractListItem, DefaultListItem, SimpleListItem, NavigationBar$1 as NavigationBar, Picker, PopOver$1 as PopOver, ProgressBar, RadioButton, DragRecognizer, PinchRecognizer, RotationRecognizer, TapRecognizer, ScrollImageView, ScrollView, SegmentedButton, Slider, SplitView, SVGView, Switch, TextArea, TextLabel, ToolBar$1 as ToolBar, View, Template, ANIMATION_DURATION, ANIMATION_DELAY, ANIMATION_NAME, ANIMATION_TIMING_FUNC, ANIMATION_FILL_MODE, TRANSITION_DURATION, TRANSITION_PROPERTY, TRANSITION_DELAY, TRANSITION_TIMING_FUNC, TRANSFORM_ORIGIN, ITERATION_COUNT, TRANSFORM, KEY_FRAMES, ANIMATION_END, TRANSITION_END, Animation, cancelAnimation, TranslateAnimation, RotateAnimation, RotateXYZAnimation, ScaleAnimation, SkewAnimation, OpacityAnimation };
