...
if (! _$jscoverage['js/vs_ext.js']) {
  ...
  _$jscoverage['js/vs_ext.js'][2141] = 0;
  _$jscoverage['js/vs_ext.js'][2143] = 0;
  _$jscoverage['js/vs_ext.js'][2144] = 0;
  _$jscoverage['js/vs_ext.js'][2169] = 0;
  _$jscoverage['js/vs_ext.js'][2171] = 0;
  _$jscoverage['js/vs_ext.js'][2174] = 0;
  _$jscoverage['js/vs_ext.js'][2175] = 0;
  ...
  _$jscoverage['js/vs_ext.js'][2185] = 0;
  _$jscoverage['js/vs_ext.js'][2187] = 0;
  _$jscoverage['js/vs_ext.js'][2188] = 0;
  _$jscoverage['js/vs_ext.js'][2203] = 0;
  ...
  _$jscoverage['js/vs_ext.js'][2234] = 0;
  _$jscoverage['js/vs_ext.js'][2235] = 0;
  _$jscoverage['js/vs_ext.js'][2237] = 0;
  _$jscoverage['js/vs_ext.js'][2238] = 0;
  _$jscoverage['js/vs_ext.js'][2239] = 0;
  _$jscoverage['js/vs_ext.js'][2240] = 0;
  ...
  _$jscoverage['js/vs_ext.js'][2268] = 0;
...
(function (window, undefined) {
  ...
  if (util.isString(index)) {
    ...
    for (i = 0; (i < this.__ab_a_items.length); (i++)) {
      ...
      panel = this.__ab_a_items[i];
      _$jscoverage['js/vs_ext.js'][2185]++;
      if ((panel.title === index)) {
        _$jscoverage['js/vs_ext.js'][2187]++;
        this.setPanelTitle(i, title);
        _$jscoverage['js/vs_ext.js'][2188]++;
        return;
      }
}
  }
}), show: (function () {
  _$jscoverage['js/vs_ext.js'][2203]++;
  ...
  var height, panel, i;
  _$jscoverage['js/vs_ext.js'][2234]++;
  panel = this.__ab_a_items[this.__ab_a_current_index];
  _$jscoverage['js/vs_ext.js'][2235]++;
  if (panel) {
    _$jscoverage['js/vs_ext.js'][2237]++;
    height = this._size[1];
    _$jscoverage['js/vs_ext.js'][2238]++;
    ...
    _$jscoverage['js/vs_ext.js'][2240]++;
  ...
  if ((e.type === core.POINTER_START)) {
    ...
    _$jscoverage['js/vs_ext.js'][2268]++;
    e.stopPropagation();
  ...
  self.__list_time_out = 0;
    ...
    if ((e.type === core.POINTER_MOVE)) {
      _$jscoverage['js/vs_ext.js'][2295]++;
      e.stopPropagation();
      ...
      _$jscoverage['js/vs_ext.js'][2300]++;
      ...
      if ((this.__elem && (delta > (ui.View.MOVE_THRESHOLD * 2)))) {
        ...
        if (this.__list_time_out) {
          ...
          _$jscoverage['js/vs_ext.js'][2311]++;
        ...
        _$jscoverage['js/vs_ext.js'][2317]++;
        this.__elem = null;
      }
    }
    else {
      ...
      if ((e.type === core.POINTER_END)) {
        ...
        document.removeEventListener(core.POINTER_MOVE, this);
        _$jscoverage['js/vs_ext.js'][2327]++;
        document.removeEventListener(core.POINTER_END, this);
        _$jscoverage['js/vs_ext.js'][2330]++;
        if (this.__elem) {
          _$jscoverage['js/vs_ext.js'][2332]++;
          if (this.__list_time_out) {
            _$jscoverage['js/vs_ext.js'][2334]++;
            clearTimeout(this.__list_time_out);
            _$jscoverage['js/vs_ext.js'][2336]++;
            util.addClassName(self.__elem, "selected");
          }
          _$jscoverage['js/vs_ext.js'][2339]++;
          this.__elem_to_unselect = this.__elem;
          _$jscoverage['js/vs_ext.js'][2340]++;
          this.__list_time_out = setTimeout((function () {
  _$jscoverage['js/vs_ext.js'][2342]++;
  util.removeClassName(self.__elem_to_unselect, "selected");
  _$jscoverage['js/vs_ext.js'][2343]++;
  self.__elem_to_unselect = null;
  _$jscoverage['js/vs_ext.js'][2344]++;
  self.__list_time_out = 0;
}), ui.View.UNSELECT_DELAY);
          _$jscoverage['js/vs_ext.js'][2347]++;
          if (util.isNumber(elem.__index)) {
            _$jscoverage['js/vs_ext.js'][2349]++;
            this.expandPanel(elem.__index);
          }
        }
        _$jscoverage['js/vs_ext.js'][2353]++;
        this.__elem = null;
      }
    }
  }
  _$jscoverage['js/vs_ext.js'][2356]++;
  return false;
})};
  ...
  _$jscoverage['js/vs_ext.js'][2375]++;
  if ((! util.isNumber(v))) {
    _$jscoverage['js/vs_ext.js'][2375]++;
    return;
  }
  _$jscoverage['js/vs_ext.js'][2376]++;
  if (((v !== Accordion.STRETCH_FILL) && (v !== Accordion.STRETCH_NONE))) {
    _$jscoverage['js/vs_ext.js'][2378]++;
    return;
  }
  _$jscoverage['js/vs_ext.js'][2380]++;
  this._stretch = v;
  _$jscoverage['js/vs_ext.js'][2382]++;
  if ((this._stretch === Accordion.STRETCH_FILL)) {
    _$jscoverage['js/vs_ext.js'][2384]++;
    util.addClassName(this.view, "fill");
  }
  else {
    _$jscoverage['js/vs_ext.js'][2388]++;
    util.removeClassName(this.view, "fill");
  }
  _$jscoverage['js/vs_ext.js'][2390]++;
  this._updateSizePanel();
}), get: (function () {
