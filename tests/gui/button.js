function launchTest (parent_view)
{
  ...
  var button2 = new vs_ui.Button ({
    ...
    style: vs_ui.Button.GREEN_STYLE
  });
  button2.init ();

  var button3 = new vs_ui.Button ({
    position:[50, 110], text: "hello", size:[130, 43],
    style: vs_ui.Button.GREY_STYLE
  });
  button3.init ();

  var button4 = new vs_ui.Button ({
    position:[200, 110], text: "hello", size:[130, 43],
    style: vs_ui.Button.RED_STYLE
  });
  button4.init ();

  var button5 = new vs_ui.Button ({
    position:[50, 170], text: "hello", size:[70, 30],
    type: vs_ui.Button.NAVIGATION_TYPE
  });
  button5.init ();

  var button6 = new vs_ui.Button ({
    position:[50, 220], text: "hello", size:[70, 30],
    type: vs_ui.Button.NAVIGATION_BACK_TYPE
  });
  button6.init ();

  var button7 = new vs_ui.Button ({
    position:[50, 270], text: "hello", size:[70, 30],
    type: vs_ui.Button.NAVIGATION_FORWARD_TYPE
  });
  button7.init ();

  var button8 = new vs_ui.Button ({
    position:[150, 170], text: "hello", size:[70, 30],
    type: vs_ui.Button.NAVIGATION_TYPE,
    style: vs_ui.Button.BLACK_STYLE
  });
  button8.init ();

  var button9 = new vs_ui.Button ({
  ...
  var button11 = new vs_ui.Button ({
    position:[250, 170], text: "hello", size:[70, 30],
    type: vs_ui.Button.NAVIGATION_TYPE,
    style: vs_ui.Button.SILVER_STYLE
  });
  button11.init ();

  var button12 = new vs_ui.Button ({
