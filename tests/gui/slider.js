...
{
  var slider = new vs.ui.Slider ({position:[50, 50], size:[300, 10]});
  slider.init ();

  test_view.appendChild (slider.view);
  slider.refresh ();

  var label1 = new vs.ui.TextLabel ({position:[50, 10], text: '0'});
  label1.init ();
  ...
  slider = new vs.ui.Slider ({position:[50, 100], size:[10, 100], 
  ...
  var label2 = new vs.ui.TextLabel ({position:[100, 100], text: '50'});
  label2.init ();
