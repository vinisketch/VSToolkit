...
GoogleSearch.loadService = function (obj)
{
  if (!GoogleSearch.__google_loaded__)
  {
    if (!GoogleSearch.__google_wait_loaded__)
    {
      ...
      vs_utils.importFile (url, null, null, 'js');
    }
...
vs_utils.extendClass (GoogleSearch, vs_core.EventSource);

/********************************************************************
                  Define class properties
********************************************************************/

vs_utils.defineClassProperties (GoogleSearch, {
  "strAddress": {
...
exports.RSSRequester = RSSRequester;
