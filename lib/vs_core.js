define(['exports', 'vs_utils', 'vs_gesture'], function (exports, vs_utils, vs_gesture) { 'use strict';
...
vs_utils__default.defineClassProperty (VSObject, "id", {
  /**
...
vs_utils.extendClass (EventSource$1, VSObject);
...
DataFlow$1._default_df_ = new DataFlow$1();
...
Model.prototype = {
  ...
  propagate : function (type, data, srcTarget)
  {
    ...
    EventSource$1.prototype.propagate.call (this, type, data, srcTarget);
  },
  ...
  propertyChange : function (property)
  {
    if (DataFlow$1._default_df_) { DataFlow$1._default_df_.propagate (this, property); }
...
vs_utils.extendClass (Model, EventSource$1);
...
Connector$1.prototype.to = function (object, property_name, func) {
  DataFlow$1._default_df_.connect (this._base_object, this.property_out, object, property_name, func);
...
vs_utils.extendClass (Task, VSObject);
