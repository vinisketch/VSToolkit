...
var MyView = vs.core.createClass ({
  ...
  initComponent : function ()
  {
    ...
    vs.addPointerListener (this.view, vs.core.POINTER_START, this);
//    vs.addPointerListener (this.view, vs.core.GESTURE_START, this);
    this.__pointers = {};
  ...
  handleEvent : function (e)
  {
    ...
    switch (e.type)
    {
      ...
      case vs.core.GESTURE_START:
        this.gestureStart (e);
        break;
        
      case vs.core.GESTURE_CHANGE:
        this.gestureChange (e);
        break;
        
      case vs.core.GESTURE_END:
        this.gestureEnd (e);
        break;
     }
    return false;
  ...
  pointerStart: function (e)
  {
    ...
    {
      vs.addPointerListener (document, vs.core.POINTER_MOVE, this);
      vs.addPointerListener (document, vs.core.POINTER_END, this);
      this._binding_ = true;
    ...
    {
      vs.removePointerListener (document, vs.core.POINTER_MOVE, this);
      vs.removePointerListener (document, vs.core.POINTER_END, this);
      this._binding_ = false;
    }
  },
...
//     console.log ('<<<<<<<<< ');
  ...
  {
    vs.addPointerListener (document, vs.core.GESTURE_CHANGE, this);
    vs.addPointerListener (document, vs.core.GESTURE_END, this);
  ...
  {
    this.__update_debug (null, null, true);
    vs.removePointerListener (document, vs.core.GESTURE_CHANGE, this);
  },
