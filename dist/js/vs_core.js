 ...
 */
var AjaxJSONP$1 = core.createClass ({
 ...
 * @param {Object} config the configuration structure
 */
function Model$1 (config)
{
  this.parent = EventSource;
  this.parent (config);
  this.constructor = Model$1;
...
vs_utils.extendClass (Model$1, EventSource);
...
vs_utils.extendClass (VSArray$1, Model$1);
 ...
 * @param {Object} config the configuration structure
 */
function DataStorage$1 (config)
{
  this.parent = EventSource$1;
  this.parent (config);
  this.constructor = DataStorage$1;

  this.__models__ = {};
}

DataStorage$1.prototype = {
...
vs_utils.extendClass (DataStorage$1, core.EventSource);
...
vs_utils.extendClass (HTTPRequest, core.EventSource);
...
vs_utils.extendClass (Task, core.Object);
