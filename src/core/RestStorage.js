...
//        var url = self._url + name + '.json';
        ...
        if (ps && ps.length)
        {
          ...
          {
            var prop_name = ps[i], value = model ['_' + underscore (prop_name)];
...
extendClass (RestStorage, DataStorage);

/********************************************************************
                  Define class properties
********************************************************************/

defineClassProperties (RestStorage, {
  "url": {
    /**
     * Setter for the url
