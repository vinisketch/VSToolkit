...
import {
  isNumber, isArray,
  free, extendClass, defineClassProperty
} from 'vs_utils';
...
defineClassProperty (Task, "state", {
...
extendClass (TaskWait, Task);

defineClassProperty (TaskWait, "state", {
